...
const Sobre = () => {
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre mim">
      <h3 className="subtitulo">Prazer, Gabriel Ghiaroni :)</h3>
      <img src={minhaFoto} alt="minha foto" className="fotoSobreMim" />
      ...
      <p className="paragrafo-sobre">
        ...
        para ser um dos mantenedores do site deles. Com isso tive minha
      </p>
      <p className="paragrafo-sobre">
